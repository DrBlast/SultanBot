...
8. Выбрать файл _runBotGold.luac_ в каталоге _SultanBot_main_
...
**Академ** - посещение академии. Просмотр рекламы доступен в платной версии
...
**Дворец** - посещение дворца. Просмотр рекламы доступен в платной версии.
...
**Реклама** - просмотр ежедневной рекламы для получения алмазов, экспериментальная функция, работает для большиснтва рекламных роликов

**Ежедневные бонусы заданий** - сбор ежедневных бонусов. В бесплатной версии без просмотра рекламы. В платной - доп опция смотреть рекламу в заданиях
...
Также в платной версии доступна опция "Море" - помошник, который бьет корабли, закрывает всплывающие сообщения.
Торг проводится в ручном режиме.
